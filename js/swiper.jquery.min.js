        ...
        if (0 !== a) {
          if ((T.params.mousewheelInvert && (a = -a), T.params.freeMode)) {
            ...
            if (
              ...
              T.updateProgress(),
              T.updateActiveIndex(),
              ((!i && T.isBeginning) || (!n && T.isEnd)) && T.updateClasses(),
      ...
      if (
        ...
        (T.container[0].swiper = T),
          ...
          (T.params.nextButton || T.params.prevButton) &&
            (T.params.nextButton &&
              ((T.nextButton = a(T.params.nextButton)),
              T.params.uniqueNavElements &&
            ...
            T.params.prevButton &&
              ((T.prevButton = a(T.params.prevButton)),
              T.params.uniqueNavElements &&
          ...
          (T.startAutoplay = function () {
            return (
              "undefined" == typeof T.autoplayTimeoutId &&
              !!T.params.autoplay &&
              !T.autoplaying &&
              ((T.autoplaying = !0), T.emit("onAutoplayStart", T), void i())
            );
          }),
          ...
          (T.pauseAutoplay = function (e) {
            T.autoplayPaused ||
              ...
              (T.autoplayPaused = !0),
              0 === e
                ? ((T.autoplayPaused = !1), i())
                : T.wrapper.transitionEnd(function () {
                    T &&
                      ((T.autoplayPaused = !1),
                      T.autoplaying ? i() : T.stopAutoplay());
                  }));
          }),
          ...
          (T.currentSlidesPerView = function () {
            ...
            if (T.params.centeredSlides) {
              ...
              for (e = T.activeIndex + 1; e < T.slides.length; e++)
                T.slides[e] &&
                  !s &&
                  ((r += T.slides[e].swiperSlideSize),
                  t++,
                  r > T.size && (s = !0));
              for (a = T.activeIndex - 1; a >= 0; a--)
                T.slides[a] &&
                  !s &&
                  ((r += T.slides[a].swiperSlideSize),
                  t++,
                  r > T.size && (s = !0));
            } else
              for (e = T.activeIndex + 1; e < T.slides.length; e++)
          ...
          (T.updateClasses = function () {
            ...
            if (
              (T.params.loop &&
                0 === r.length &&
                ((r = T.slides.eq(-1)), r.addClass(T.params.slidePrevClass)),
              s.loop &&
              ...
              if (
                (T.params.loop
                  ? ((i = Math.ceil(
                    ...
                    i > T.slides.length - 1 - 2 * T.loopedSlides &&
              ...
              "custom" === T.params.paginationType &&
                ...
                (T.paginationContainer.html(
                  T.params.paginationCustomRender(T, i + 1, n)
                ),
          ...
          (T.initEvents = function (e) {
            var a = e ? "off" : "on",
              ...
              n = !!T.params.nested;
            if (T.browser.ie)
              r[t](T.touchEvents.start, T.onTouchStart, !1),
              ...
              ((s.simulateTouch && !T.device.ios && !T.device.android) ||
                (s.simulateTouch && !T.support.touch && T.device.ios)) &&
                (r[t]("mousedown", T.onTouchStart, !1),
            ...
            if (
              ...
              if (T.params.loop) {
                ...
                (i = parseInt(
                  ...
                  T.params.centeredSlides
                    ? o < T.loopedSlides - l / 2 ||
                      o > T.slides.length - T.loopedSlides + l / 2
                      ? (T.fixLoop(),
                        (o = T.wrapper
                          .children(
                            "." +
        ...
        (T.onTouchStart = function (e) {
                    ...
                    (T.allowClick = !1),
                      ...
                      C ||
                        ...
                        !T.params.grabCursor ||
                          ...
                          T.setGrabCursor(!0)),
                      (C = !0);
                    var r = (T.touches.diff = T.isHorizontal()
                      ? T.touches.currentX - T.touches.startX
                      : T.touches.currentY - T.touches.startY);
            ...
            if (
              ...
              if (
                (T.allowClick &&
                  ...
                  s < 300 &&
                    t - H < 300 &&
                    (D && clearTimeout(D), T.emit("onDoubleTap", T, e))),
                (H = Date.now()),
                setTimeout(function () {
                  T && (T.allowClick = !0);
                }, 0),
              ...
              if (
                ...
                if (T.params.freeModeMomentum) {
                  ...
                  if (u < T.maxTranslate())
                    ...
                    T.params.freeModeMomentumBounce
                      ? (u - T.minTranslate() > g && (u = T.minTranslate() + g),
                        (m = T.minTranslate()),
                        (c = !0),
                        (L = !0))
                      : (u = T.minTranslate());
                  ...
                  T.params.freeModeMomentumBounce && c
                    ? (T.updateProgress(m),
              ...
              for (v = 0; v < T.slidesGrid.length; v += T.params.slidesPerGroup)
                "undefined" != typeof T.slidesGrid[v + T.params.slidesPerGroup]
                  ? r >= T.slidesGrid[v] &&
                    r < T.slidesGrid[v + T.params.slidesPerGroup] &&
                    ((w = v),
                    (y =
          ...
          (T.slideTo = function (e, a, t, s) {
            ...
            if (
              ...
              for (var i = 0; i < T.slidesGrid.length; i++)
                -Math.floor(100 * r) >= Math.floor(100 * T.slidesGrid[i]) &&
                  (e = i);
            return (
              !(
                !T.params.allowSwipeToNext &&
          ...
          (T.getWrapperTranslate = function (e) {
            return (
              "undefined" == typeof e && (e = T.isHorizontal() ? "x" : "y"),
          ...
          (T.initObservers = function () {
            if (T.params.observeParents)
              for (var e = T.container.parents(), a = 0; a < e.length; a++)
                o(e[a]);
            o(T.container[0], { childList: !1 }),
              o(T.wrapper[0], { attributes: !1 });
          }),
          ...
          (T.effects = {
                ...
                if (
                  ...
                  T.slides.eq(T.activeIndex).transitionEnd(function () {
                    if (
                      !t &&
                      T &&
                      a(this).hasClass(T.params.slideActiveClass)
                    ) {
                      (t = !0), (T.animating = !1);
                      for (
                        var e = [
            ...
            coverflow: {
              setTranslate: function () {
                for (
                  var e = T.translate,
                    t = T.isHorizontal() ? -e + T.width / 2 : -e + T.height / 2,
                    s = T.isHorizontal()
              ...
              if (T.params.scrollbar) {
                ...
                (e.track = a(T.params.scrollbar)),
                  T.params.uniqueNavElements &&
                    ...
                    (e.track = T.container.find(T.params.scrollbar)),
              ...
              function s(a) {
                (e =
                  ...
                  (i && "container" !== T.params.controlBy) ||
                    ...
                    (i = (e - T.minTranslate()) * r + a.minTranslate())),
          ...
          (T.disableMousewheelControl = function () {
            ...
            return (
              "container" !== T.params.mousewheelEventsTarged &&
                (e = a(T.params.mousewheelEventsTarged)),
              ...
              if (T.params.zoom) {
                ...
                T.support.gestures
                  ...
                  T.slides.each(function (e, s) {
                    a(s).find("." + T.params.zoomContainerClass).length > 0 &&
                      a(s)[t](T.touchEvents.move, T.zoom.onTouchMove);
                  }),
