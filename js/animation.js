  ...
  switch (activeCorner) {
    case "top-left":
      if (window.innerWidth <= 450) {
        ...
        tlContent.style.transform = "translateX(5vw) translateY(100px)";
        tlContent.style.width = "30vw";
        tlContent.style.height = "200vh";
        tlContent.style.top = "-300px";
        tlContent.style.display = "block";
        tlContent.style.alignItems = "center";
        tlContent.style.justifyContent = "center";
        tlContent.style.background = "#ffff0000";
        ...
        tlContent.style.width = "30vw";
        tlContent.style.height = "200vh";
        tlContent.style.top = "100px";
        tlContent.style.display = "block";
        tlContent.style.alignItems = "center";
        tlContent.style.justifyContent = "center";
        tlContent.style.background = "#ffffff00";
        tlContent.style.zIndex = "200";
        tlBtn.style.zIndex = "300";
        trBtn.style.zIndex = "100";
        blBtn.style.zIndex = "100";
        ...
        tlContent.style.width = "30vw";
        tlContent.style.height = "200vh";
        tlContent.style.top = "20px";
        tlContent.style.left = "50px";
        tlContent.style.display = "block";
      }
      break;
    ...
    case "bottom-left":
      if (window.innerWidth <= 600) {
        ...
        blContent.style.top = "2.5vh";
        blContent.style.left = "-3vh";
    ...
    case "bottom-right":
      if (window.innerWidth <= 450) {
        ...
        brContent.style.bottom = "110vh";
        brContent.style.left = "12vh";
        ...
        brContent.style.background = "#ffffff85";
